 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://www.javaedu.com", wsdlLocation = "http://127.0.0.1:8001/webservice/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://www.javaedu.com", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8001/webservice/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://www.javaedu.com", "helloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.javaedu.com", "helloPort"), Hello.class, features);
    }
